...
pokomonDetails pokomonDetailsFromJson(String str) => pokomonDetails.fromJson(json.decode(str));

String pokomonDetailsToJson(pokomonDetails data) => json.encode(data.toJson());

class pokomonDetails {
  pokomonDetails({required this.abilities,
  ...
  factory pokomonDetails.fromJson(Map<String, dynamic> json) => pokomonDetails(
